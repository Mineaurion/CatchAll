...
public class McheckCommand {
    ...
    public McheckCommand(CommandDispatcher<CommandSource> dispatcher){
        dispatcher.register(Commands.literal("mcheck")
                ...
                .executes((cmdcntxt) -> {
                    ...
                    Iterable<ServerWorld> serverlevel = (Iterable<ServerWorld>) server.getAllLevels();
                    ...
                    for(ServerWorld level : serverlevel){
